...
c.create_rectangle(80, 80, 120, 160, fill='yellow', outline='green', width=3, activedash=(5, 4))

# треугольник - вершина, левый угол, правый угол
c.create_polygon(220, 10, 160, 60, 280, 60)
# трапеция
c.create_polygon(190, 80, 250, 80, 280, 160, 160, 160, fill='orange', outline='black')

# круг
c.create_oval(330, 10, 380, 60, width=2)
# овал
c.create_oval(300, 100, 410, 160, fill='grey70', outline='black')
# круг
c.create_oval(450, 10, 600, 160, fill='lightgrey', outline='black')
# сектор
